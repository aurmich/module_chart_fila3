# Translation Audit Patterns -  Project
...
- **Generated Keys**: 
  - `::patient.widgets.states_chart.heading` (when model = Patient::class)
  - `::doctor.widgets.states_chart.heading` (when model = Doctor::class)
  - `::appointment.widgets.states_chart.heading` (when model = Appointment::class)
...
- **Files**: `laravel/Modules//lang/{locale}/widgets.php` and `states.php`
...
::{model}.widgets.{widget_name}.title
::{model}.widgets.{widget_name}.label
::{model}.widgets.{widget_name}.description
```
...
- `laravel/Modules//lang/it/widgets.php`
- `laravel/Modules//lang/en/widgets.php`
- `laravel/Modules//lang/de/widgets.php`
- `laravel/Modules//lang/it/states.php`
- `laravel/Modules//lang/en/states.php`
- `laravel/Modules//lang/de/states.php`
