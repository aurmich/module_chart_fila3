...
├── lang/
│   ├── en/
│   │   ├── auth.php           # Traduzioni autenticazione (completo)
│   │   ├── appointment.php    # Traduzioni appuntamenti
│   │   └── theme.php          # Traduzioni tema generale
│   ├── it/
│   │   ├── auth.php           # Traduzioni autenticazione (completo)
│   │   ├── appointment.php    # Traduzioni appuntamenti
│   │   ├── patient_states.php # Stati pazienti
│   │   ├── doctor_states.php  # Stati dottori
│   │   ├── txt.php           # Testi generali
│   │   ├── wizard.php        # Wizard
│   │   └── theme.php         # Traduzioni tema generale
│   └── ...
```

## Traduzioni di Autenticazione

Il tema One include un sistema completo di traduzioni per l'autenticazione. Per informazioni dettagliate sui file di traduzione auth, consultare:
...
```php
// Esempi di utilizzo
{{ __('pub_theme::auth.login.title') }}           // "Accedi al tuo account"
{{ __('pub_theme::auth.login.or') }}              // "oppure"
{{ __('pub_theme::auth.login.create_account') }}  // "crea un nuovo account"
{{ __('pub_theme::auth.login.forgot_password') }} // "Hai dimenticato la password?"
```
