...
<body class="min-h-screen flex items-center justify-center bg-gray-100 text-center">
    <div>
        <h1 class="text-4xl font-bold mb-4">Errore 419</h1>
        <p class="text-lg text-gray-700">Sessione scaduta</p>
    </div>
...
=======
=======
>>>>>>> f54b052a (✨ (error pages): redesign error pages (403, 419, 429, 500) with engaging)
{{--
/**
