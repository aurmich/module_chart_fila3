...
<div class="bg-[#E6EBF7] lg:grid grid-cols-2 gap-4 sm:grid grid-cols-1">
      {{-- TITOLO E BOTTONI --}}
      <div class="flex flex-col justify-center">
          <section 
              class="flex flex-col justify-center bg-[#E6EBF7] relative overflow-hidden"
              aria-labelledby="hero-heading">
              <div class="m-5">
                  <div>
              ...
              {{-- BOTTONI --}}
               <div class="w-full flex justify-center bg-[#E6EBF7] !py-8 sm:py-32 mx-auto">
                <div class="w-full mx-auto max-w-7xl lg:px-6 sm:px-3">
                    <div class="flex flex-col mx-auto w-full max-w-2xl px-4 sm:px-6 lg:px-0 gap-4">
                      <div class="w-full bg-[#DBE3EE] p-6 rounded-lg text-lg flex justify-between cursor-pointer">Anagrafica 
                      ...
                      <div class="w-full bg-[#DBE3EE] p-6 rounded-lg text-lg flex justify-between cursor-pointer">Azioni
                      <span class="cursor-pointer">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M17.25 8.25 21 12m0 0-3.75 3.75M21 12H3" />
                            </svg>
