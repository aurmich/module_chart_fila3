...
<<<<<<< HEAD
    ...
    <div class="bg-[#DDE5EB] w-full lg:w-2/4 flex flex-row items-center justify-between p-5 mt-5 rounded-[15px]">
             <div>
                 <span class="text-[#BF0303] text-lg">Mara Rossi</span>
                 <div>
                 <p class="text-[#BF0303] text-xs">19 Giugno 2025</p>
            ...
            <div class="flex flex-col-reverse items-center lg:flex-row">
                <p class="text-[#BF0303] text-sm pr-1">Apri dettaglio</p>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#BF0303" class="size-6">
                 <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 4.5 21 12m0 0-7.5 7.5M21 12H3" />
                </svg>
            </div>
