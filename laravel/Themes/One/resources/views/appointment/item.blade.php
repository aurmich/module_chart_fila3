...
new class extends Component  {
    ...
    public function downloadReport()
    {
       ...
       //$html = 'test1';
       //return app(StreamDownloadPdfAction::class)->execute(html:$html, filename:'report-' . $this->appointment->id . '.pdf');
    ...
    <div class="w-full flex justify-center">
        <div class="flex flex-col justify-center">
            ...
            <div class="relative w-64 h-48 mt-5 rounded-[25px] bg-[#E6EBF7] shadow-2xl overflow-hidden">
                ...
                <button wire:click="downloadReport" class="flex items-center justify-between absolute bottom-0 left-0 w-full bg-[#E6EBF7B3] text-[#272C4D] px-3 text-center text-xl font-extrabold py-5 transition-all duration-300 ease-in-out hover:py-9" title="@lang('pub_theme::appointment.report.download_tooltip')">
