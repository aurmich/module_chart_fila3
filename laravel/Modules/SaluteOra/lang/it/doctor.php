...
return [
  ...
  'name' => 'Medici',
  // navigation usa un identificatore custom: <modulo>-<icona> (vedi resources/svg/saluteora-doctor.svg)
  'navigation' => [
    'label' => 'Medici',
    'group' => 'Gestione Utenti',
    'icon' => 'saluteora-doctor', // Icona registrata nel ServiceProvider
    'color' => 'primary',
    'sort' => 7,
