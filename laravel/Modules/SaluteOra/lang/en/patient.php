...
<<<<<<< HEAD
    ...
    'widgets' => [
        'user_type_registrations_chart' => [
            'heading' => 'Patient Registrations by Type',
            'description' => 'Chart showing patient registrations distribution by user type',
            'helper_text' => 'Visual representation of patient registration trends',
        ],
        'states_chart' => [
            'heading' => 'Patient Status Distribution',
            'description' => 'Chart showing distribution of patients by status',
            'helper_text' => 'Overview of patient status across the system',
        ],
        'creation_chart' => [
            'heading' => 'Patient Creation Trends',
            'description' => 'Chart showing patient creation over time',
            'helper_text' => 'Timeline view of new patient registrations',
        ],
        'trend_chart' => [
            'heading' => 'Patient Activity Trends',
            'description' => 'Chart showing patient activity trends',
            'helper_text' => 'Analysis of patient engagement patterns',
        ],
    ],
    ...
    'states' => [
        ...
        'pending' => [
            'label' => 'Pending',
            'description' => 'Patient registration is pending approval',
            'tooltip' => 'Patient is waiting to be approved',
            'color' => 'warning',
            'icon' => 'heroicon-o-clock',
        ],
        'inactive' => [
            'label' => 'Inactive',
            'description' => 'Patient is not active in the system',
            'tooltip' => 'Patient has been deactivated',
            'color' => 'danger',
            'icon' => 'heroicon-o-x-circle',
        ],
        'rejected' => [
            'label' => 'Rejected',
            'description' => 'Patient registration was rejected',
            'tooltip' => 'Patient registration has been rejected',
            'color' => 'danger',
            'icon' => 'heroicon-o-x-mark',
        ],
        'suspended' => [
            'label' => 'Suspended',
            'description' => 'Patient temporarily suspended',
            'tooltip' => 'Patient has been temporarily suspended',
            'color' => 'warning',
        ...
        'integration_requested' => [
            ...
            'tooltip' => 'Patient must integrate documentation',
            'color' => 'info',
        ...
        'integration_completed' => [
            ...
            'tooltip' => 'Patient has completed documentation integration',
            'color' => 'success',
