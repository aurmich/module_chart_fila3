...
namespace Modules\SaluteOra\Filament\Resources\AppointmentWorkflowResource\Forms;
...
use Modules\SaluteOra\Actions\SendAppointmentNotificationAction;
...
use Modules\SaluteOra\Models\PatientIsee;

/**
 * Classe che gestisce il form per la verifica dell'idoneità al programma il progetto.
                ...
                ->schema([
                    ...
                    Forms\Components\Actions::make([
                        Forms\Components\Actions\Action::make('verify_eligibility')
                            ...
                            ->modalDescription('Questa operazione verificherà l\'idoneità della paziente al programma il progetto. Confermi di procedere?')
