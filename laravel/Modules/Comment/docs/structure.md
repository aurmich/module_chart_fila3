...
- [Guida generale MCP](/docs/mcp/README.md)
- [Server MCP consigliati per il modulo Xot](../../../Xot/docs/MCP_SERVER_RECOMMENDED.md)
...
Per dettagli e best practice consulta la [guida generale MCP](/docs/mcp/README.md) nel workspace.
