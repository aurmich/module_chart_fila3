...
cat /var/www/html/_bases/base_<nome progetto>/laravel/Modules/User/app/Console/Commands/ChangeTypeCommand.php

# Controlla documentazione filosofica:
cat /var/www/html/_bases/base_<nome progetto>/laravel/Modules/User/docs/console_commands_philosophy.md
```
